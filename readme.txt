...
== Description ==
TheShop.biz provides the WordPress users with this easy to use WordPress Plugin which can be used to create an online store in just a matter of minutes. After the plugin is installed, it is ready to use after the "activate button" has been pressed. You can show the store on WP using the Following Shortcode: <br />
[shop-biz username"your-username"]TheShop Name[/shop-biz]<br />
